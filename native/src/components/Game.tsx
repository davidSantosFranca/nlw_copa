  ...
  return (
    ...
    >
      ...
      <Text color="gray.200" fontSize="xs">
        {dayjs(data.date).locale(ptBR ).format("DD [de] MMMM [de] YYYY")}
      </Text>

      <HStack mt={4} w="full" justifyContent="space-between" alignItems="center">
        <Team
          code={data.firstTeamCountryCode}
          defaultValue={data.guess?.firstTeamPoints.toString()??''}
          position="right"
        ...
        <Team
          ...
          defaultValue={data.guess?.secondTeamPoints.toString()??''}
          position="left"
